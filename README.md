...
<em><strong>Overview of Solution:</strong></em>
...
<em><strong>NIST SP 800-22 (Statistical Test Suite for Random and Pseudorandom Number Generators)</strong></em>
...
<em><strong>Bit Rate in bps (bits per second):</strong></em>
